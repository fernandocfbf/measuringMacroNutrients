...
def load_data():
    ...
    with os.scandir('pizza/') as entries:
        for entry in entries:
            diretorio = "pizza/" + entry.name #pega o diretório das fotos
    ...
    with os.scandir('non-pizza/') as entries:
        for entry in entries:
            diretorio = "non-pizza/" + entry.name #pega o diretório das fotos
            imagem = mpimg.imread(diretorio) #le a imagem atual
            img_resized = resize(imagem, (64,64)) #redimensiona a imagem para ser 64 x 64
            matriz = np.array(img_resized) #cria um array com cada imagem (64 x 64 x 3) 
